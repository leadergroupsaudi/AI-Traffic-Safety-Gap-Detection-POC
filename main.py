...
def main():
    ...
    snapshot_extractor = SnapshotExtractor(
        "/home/user/Desktop/AI Traffic Safety/Rule Engine/Sample_full_video.mp4"
    )

    print("Loading tracking data...")
    tracking_df = pd.read_excel("data/raw/unique_objects_tracking_old.xlsx")
    ...
    rules_engine = RulesEngine("rules/saudi_traffic_rules.yaml")
    ...
    for f_obj in findings_objects:
        ...
        # Extract snapshot
        snapshot_path = f"snapshots/{finding['finding_id']}.jpg"
    ...
    result_df.to_csv("data/exports/findings.csv", index=False)
